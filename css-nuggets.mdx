...
<span
  style={{
    ...
    fontWeight: "bold",
    background:
      "url(https://media.giphy.com/media/12p8b9acuBMdYQ/giphy.gif)",
    color: "transparent",
    WebkitBackgroundClip: "text"
  }}
>
...
<iframe
  ...
  scrolling="no"
  title="wbqGvo"
  src="//codepen.io/rikukissa/embed/wbqGvo/?height=265&theme-id=0&default-tab=css,result"
  frameborder="no"
  allowtransparency="true"
  allowfullscreen="true"
>
  See the Pen <a href="https://codepen.io/rikukissa/pen/wbqGvo/">wbqGvo</a> by
  Riku Rouvila (<a href="https://codepen.io/rikukissa">@rikukissa</a>) on{" "}
  <a href="https://codepen.io">CodePen</a>.
</iframe>
