...
<Notes>
  <ul>
    <li>You might not love CSS, that's fine</li>
    <li>This is the world we live in</li>
    <li>
      Most of the CSS confusion is just about not understanding it's quirks
    </li>
    <li>
      Presentation contains practical tips for everyday use on all skill levels
    </li>
  </ul>
</Notes>
