...
<Image size="contain" src="images/turkuedition.jpg" />
...
<Image src="images/mug.jpg" />

---

<Image size="contain" src="images/familyguy.gif" />

<Notes>
  <ul>
    <li>It's too easy to laugh at CSS.</li>
    <li>Let's all laugh at CSS so we get that out of our systems.</li>
  </ul>
</Notes>
...
<Notes>
  <ul>
    <li>
      A: CSS is like that one cousin who's always drunk at parties and says the
      stupidest politically incorrect things
    </li>
    <li>You don't like them but have to live with them</li>
    <li>
      A: Most of the confusion about that drunk cousin is just about not
...
<Image size="contain" src="images/solution.png" />

<Notes>
  <ul>
    <li>With the exception of the internet's favorite joke</li>
    <li>No CSS presentation is complete without laughing at IE</li>
...
<Notes>
  <ul>
    ...
    <li>I guess it sounded like a good idea at the time...?</li>
  </ul>
</Notes>
...
<Image size="contain" src="images/rikudesktop.png" />
...
<Notes>
  <ul>
    <li>Dankest nugget of them all</li>
    <li>Most dope</li>
    <li>Most moist</li>
    <li>Most Gucci</li>
    <li>Most lit</li>
